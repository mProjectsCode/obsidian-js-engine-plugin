<script lang="ts">
	...
	import Button from 'packages/jsEngine/src/utils/Button.svelte';
	import ModalButtonGroup from 'packages/jsEngine/src/utils/ModalButtonGroup.svelte';
	import type { StartupScriptsModal } from './StartupScriptModal';
	import { ButtonStyleType } from 'packages/jsEngine/src/utils/Util';
	import { Menu } from 'obsidian';
	import Icon from 'packages/jsEngine/src/utils/Icon.svelte';
