...
declare module "utils/Validators" {
    ...
    import type { ButtonPromptButtonOptions, ButtonPromptOptions, ConfirmPromptOptions, InputPromptOptions, NumberInputPromptOptions, SuggesterOption, SuggesterPromptOptions, YesNoPromptOptions } from "api/PromptAPI";
...
declare module "api/MarkdownAPI" {
    import type { API } from "api/API";
    import { BlockQuoteElement, CalloutElement, CodeBlockElement, CodeElement, HeadingElement, ListElement, ParagraphElement, TableElement, TextElement } from "api/markdown/AbstractMarkdownElementContainer";
