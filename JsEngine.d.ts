declare module "jsEngine/src/api/API" {
  import type { App, Plugin, TFile } from 'obsidian';
  import * as Obsidian from 'obsidian';
  import type { InstanceId } from 'jsEngine/src/api/InstanceId';
  import { InternalAPI } from 'jsEngine/src/api/Internal';
  import { LibAPI } from 'jsEngine/src/api/LibAPI';
  import { MarkdownAPI } from 'jsEngine/src/api/MarkdownAPI';
  import { MessageAPI } from 'jsEngine/src/api/MessageAPI';
  import { PromptAPI } from 'jsEngine/src/api/PromptAPI';
  import { QueryAPI } from 'jsEngine/src/api/QueryAPI';
  import { ReactiveComponent } from 'jsEngine/src/api/reactive/ReactiveComponent';
  import type { JsFunc } from 'jsEngine/src/engine/JsExecution';
  import type JsEnginePlugin from 'jsEngine/src/main';
  import { MarkdownLink } from 'jsEngine/src/utils/Link';
  import type { Validators } from 'jsEngine/src/utils/Validators';
  export class API {
      /**
...
declare module "jsEngine/src/api/InstanceId" {
  import type { ExecutionContext } from 'jsEngine/src/engine/JsExecution';
...
declare module "jsEngine/src/api/Internal" {
  import { Component } from 'obsidian';
  import type { API } from 'jsEngine/src/api/API';
  import type { EngineExecutionParams } from 'jsEngine/src/engine/Engine';
  import type { JsExecution, ExecutionContext, JsExecutionGlobals, JsExecutionGlobalsConstructionOptions, MarkdownCodeBlockExecutionContext, JSFileExecutionContext, UnknownExecutionContext, MarkdownCallingJSFileExecutionContext, MarkdownOtherExecutionContext } from 'jsEngine/src/engine/JsExecution';
  import { ResultRenderer } from 'jsEngine/src/engine/ResultRenderer';
...
declare module "jsEngine/src/api/markdown/AbstractMarkdownElement" {
  import type { API } from 'jsEngine/src/api/API';
  import { MarkdownString } from 'jsEngine/src/api/markdown/MarkdownString';
...
declare module "jsEngine/src/api/markdown/AbstractMarkdownElementContainer" {
  import type { API } from 'jsEngine/src/api/API';
  import { AbstractMarkdownElement } from 'jsEngine/src/api/markdown/AbstractMarkdownElement';
  import { AbstractMarkdownLiteral } from 'jsEngine/src/api/markdown/AbstractMarkdownLiteral';
  import { MarkdownElementType } from 'jsEngine/src/api/markdown/MarkdownElementType';
...
declare module "jsEngine/src/api/markdown/AbstractMarkdownLiteral" {
  import { AbstractMarkdownElement } from 'jsEngine/src/api/markdown/AbstractMarkdownElement';
  import { MarkdownElementType } from 'jsEngine/src/api/markdown/MarkdownElementType';
...
declare module "jsEngine/src/api/markdown/MarkdownBuilder" {
  import type { API } from 'jsEngine/src/api/API';
  import type { AbstractMarkdownElement } from 'jsEngine/src/api/markdown/AbstractMarkdownElement';
  import { AbstractMarkdownElementContainer } from 'jsEngine/src/api/markdown/AbstractMarkdownElementContainer';
  /**
...
declare module "jsEngine/src/api/markdown/MarkdownElementType" {
...
declare module "jsEngine/src/api/markdown/MarkdownString" {
  import type { API } from 'jsEngine/src/api/API';
  /**
...
declare module "jsEngine/src/api/MarkdownAPI" {
  import type { API } from 'jsEngine/src/api/API';
  import { BlockQuoteElement, CalloutElement, CodeBlockElement, CodeElement, HeadingElement, ListElement, ParagraphElement, TableElement, TextElement } from 'jsEngine/src/api/markdown/AbstractMarkdownElementContainer';
  import { MarkdownBuilder } from 'jsEngine/src/api/markdown/MarkdownBuilder';
  import { MarkdownString } from 'jsEngine/src/api/markdown/MarkdownString';
  /**
...
declare module "jsEngine/src/api/MessageAPI" {
  import type { API } from 'jsEngine/src/api/API';
  import type { MessageManager, MessageType, MessageWrapper } from 'jsEngine/src/messages/MessageManager';
...
declare module "jsEngine/src/api/PromptAPI" {
  import type { API } from 'jsEngine/src/api/API';
...
declare module "jsEngine/src/api/prompts/Suggester" {
  import type { App } from 'obsidian';
  import { FuzzySuggestModal } from 'obsidian';
  import type { SuggesterOption, SuggesterPromptOptions } from 'jsEngine/src/api/PromptAPI';
...
declare module "jsEngine/src/api/prompts/SvelteModal" {
  import type { App } from 'obsidian';
  import { Modal } from 'obsidian';
  import type { ModalPromptOptions } from 'jsEngine/src/api/PromptAPI';
  import type { AnySvelteComponent, MountedComponent } from 'jsEngine/src/utils/SvelteUtils';
  export class SvelteModal<Component extends AnySvelteComponent, T> extends Modal {
      ...
      private readonly onSubmit;
      private submitted;
      constructor(app: App, options: ModalPromptOptions, createComponent: (modal: SvelteModal<Component, T>, targetEl: HTMLElement) => MountedComponent<Component>, onSubmit: (value: T | undefined) => void);
      onOpen(): void;
      onClose(): void;
      submit(value: T): void;
  }
...
declare module "jsEngine/src/api/QueryAPI" {
...
declare module "jsEngine/src/api/reactive/ReactiveComponent" {
  import type { API } from 'jsEngine/src/api/API';
  import type { JsFunc } from 'jsEngine/src/engine/JsExecution';
  /**
...
declare module "jsEngine/src/engine/Engine" {
  import type { App, Component } from 'obsidian';
  import type { ExecutionContext } from 'jsEngine/src/engine/JsExecution';
  import { JsExecution } from 'jsEngine/src/engine/JsExecution';
  import type JsEnginePlugin from 'jsEngine/src/main';
  /**
...
declare module "jsEngine/src/engine/JsExecution" {
  import type { App, CachedMetadata, Component, TFile } from 'obsidian';
  import type * as Obsidian from 'obsidian';
  import { API } from 'jsEngine/src/api/API';
  import type { EngineExecutionParams } from 'jsEngine/src/engine/Engine';
  import type JsEnginePlugin from 'jsEngine/src/main';
  import type { MessageWrapper } from 'jsEngine/src/messages/MessageManager';
  /**
   ...
   */
  export type ExecutionContext = MarkdownCodeBlockExecutionContext | MarkdownCallingJSFileExecutionContext | MarkdownOtherExecutionContext | JSFileExecutionContext | UnknownExecutionContext;
  /**
...
declare module "jsEngine/src/engine/ResultRenderer" {
...
declare module "jsEngine/src/fileRunner/JSFileSelectModal" {
...
declare module "jsEngine/src/index" {
  export * from 'jsEngine/src/engine/Engine';
  export * from 'jsEngine/src/engine/JsExecution';
  export * from 'jsEngine/src/engine/ResultRenderer';
  export * from 'jsEngine/src/api/API';
  export * from 'jsEngine/src/api/InstanceId';
  export * from 'jsEngine/src/api/Internal';
  export * from 'jsEngine/src/api/LibAPI';
  export * from 'jsEngine/src/api/MarkdownAPI';
  export * from 'jsEngine/src/api/MessageAPI';
  export * from 'jsEngine/src/api/PromptAPI';
  export * from 'jsEngine/src/api/QueryAPI';
  export * from 'jsEngine/src/api/reactive/ReactiveComponent';
  export * from 'jsEngine/src/api/markdown/AbstractMarkdownElement';
  export * from 'jsEngine/src/api/markdown/AbstractMarkdownElementContainer';
  export * from 'jsEngine/src/api/markdown/AbstractMarkdownLiteral';
  export * from 'jsEngine/src/api/markdown/MarkdownString';
  export * from 'jsEngine/src/api/markdown/MarkdownBuilder';
  export * from 'jsEngine/src/api/markdown/MarkdownElementType';
}

declare module "jsEngine/src/JsMDRC" {
  import type { MarkdownPostProcessorContext } from 'obsidian';
  import { MarkdownRenderChild, TFile } from 'obsidian';
  import type { ExecutionContext, JsExecution } from 'jsEngine/src/engine/JsExecution';
  import type JsEnginePlugin from 'jsEngine/src/main';
...
declare module "jsEngine/src/main" {
  import type { App, PluginManifest } from 'obsidian';
  import { Plugin } from 'obsidian';
  import { API } from 'jsEngine/src/api/API';
  import { Engine } from 'jsEngine/src/engine/Engine';
...
declare module "jsEngine/src/messages/MessageDisplay" {
  import type { App } from 'obsidian';
  import { Modal } from 'obsidian';
  import type JsEnginePlugin from 'jsEngine/src/main';
...
declare module "jsEngine/src/messages/MessageManager" {
  ...
  import type { InstanceId } from 'jsEngine/src/api/InstanceId';
  import type JsEnginePlugin from 'jsEngine/src/main';
  import { Signal } from 'jsEngine/src/utils/Signal';
...
declare module "jsEngine/src/settings/Settings" {
  import type { App } from 'obsidian';
...
declare module "jsEngine/src/settings/StartupScriptModal" {
  import { Modal } from 'obsidian';
  import type JsEnginePlugin from 'jsEngine/src/main';
...
declare module "jsEngine/src/utils/Errors" {
...
declare module "jsEngine/src/utils/Link" {
...
declare module "jsEngine/src/utils/Signal" {
...
declare module "jsEngine/src/utils/SvelteUtils" {
  import type { Component, SvelteComponent } from 'svelte';
  export type AnyRecord = Record<string, any>;
  export type UnknownRecord = Record<string, unknown>;
  type IfAny<T, Y, N> = 0 extends 1 & T ? Y : N;
  export type ComponentExports<Comp extends Component<any, any> | SvelteComponent> = Comp extends SvelteComponent<any, infer Exports> ? IfAny<Exports, AnyRecord, Exports> : AnyRecord;
...
declare module "jsEngine/src/utils/UseIcon" {
  export function useIcon(node: HTMLElement, icon: string): {
      update: (icon: string) => void;
  };
}

declare module "jsEngine/src/utils/Util" {
...
declare module "jsEngine/src/utils/Validators" {
  ...
  import { AbstractMarkdownElement } from 'jsEngine/src/api/markdown/AbstractMarkdownElement';
  import type { TableElementType } from 'jsEngine/src/api/markdown/AbstractMarkdownElementContainer';
  import type { ButtonPromptButtonOptions, ButtonPromptOptions, ConfirmPromptOptions, InputPromptOptions, NumberInputPromptOptions, SuggesterOption, SuggesterPromptOptions, YesNoPromptOptions } from 'jsEngine/src/api/PromptAPI';
  import type { EngineExecutionParams } from 'jsEngine/src/engine/Engine';
  import type { Block, ExecutionContext, JsExecutionGlobalsConstructionOptions, JSFileExecutionContext, MarkdownCallingJSFileExecutionContext, MarkdownCodeBlockExecutionContext, MarkdownOtherExecutionContext, UnknownExecutionContext } from 'jsEngine/src/engine/JsExecution';
...
declare module "jsEngine/src" {
  export * from "jsEngine/src/index";
}
