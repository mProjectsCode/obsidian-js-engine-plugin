...
declare module "jsEngine/api/MarkdownAPI" {
    ...
    import { MarkdownString } from "jsEngine/api/markdown/MarkdownString";
    import { BlockQuoteElement, CalloutElement, CodeBlockElement, CodeElement, HeadingElement, ListElement, ParagraphElement, TableElement, TextElement } from "jsEngine/api/markdown/AbstractMarkdownElementContainer";
